...
def upgrade() -> None:
    user_role = PGEnum("CLIENT", "MASTER", "ADMIN", name="userrole", create_type=False)
    ticket_status = PGEnum("DRAFT", "WAITING_PHOTOS", "AI_ANALYSIS", "NEW", "ACCEPTED", "IN_PROGRESS", "WAITING_APPROVAL", "DONE", "CANCELLED", name="ticketstatus", create_type=False)
    media_type = PGEnum("PHOTO", "VOICE", name="mediatype", create_type=False)
    slot_status = PGEnum("RESERVED", "BUSY", "DONE", "CANCELLED", name="calendarslotstatus", create_type=False)
